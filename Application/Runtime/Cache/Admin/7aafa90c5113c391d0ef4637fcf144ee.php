...
<table class="form-table">
	<tr class="form-field form-required">
		<th scope="row"><label for="d_name">姓名</label></th>
		<td><input name="d_name" type="text" id="d_name" value="" aria-required="true" /></td>
	</tr>
	</table>


<p class="submit"><input type="submit" name="createuser" id="createusersub" class="button button-primary" value="添加专家"  /></p>
</form>
</div>
