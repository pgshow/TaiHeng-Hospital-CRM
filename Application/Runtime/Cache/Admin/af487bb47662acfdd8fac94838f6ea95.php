...
<div class="wrap">
<h2 id="add-new-user"> 修改密码</h2>


<div id="ajax-response"></div>

<p>修改用户　<?php echo ($employee["user_name"]); ?>　的密码</p>
<form method="post" name="password" id="createuser" class="validate" novalidate>
<input type="hidden" name="http_referer" value="<?php echo $_SERVER['HTTP_REFERER']; ?>" />
<table class="form-table">
	<tr class="form-field form-required">
		<th scope="row"><label for="user_pass">新密码</label></th>
		<td><input name="user_pass" type="text" id="user_pass" value="" aria-required="true" /></td>
	</tr>
</table>


<p class="submit"><input type="submit" name="createuser" id="createusersub" class="button button-primary" value="确认修改"  /></p>
</form>
</div>
