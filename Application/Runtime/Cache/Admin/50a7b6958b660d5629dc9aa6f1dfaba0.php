...
<div class="wrap">
<h2>
员工	<a href="<?php echo U('Employee/addemployee');?>" class="add-new-h2">添加员工</a>
</h2>

<ul class='subsubsub'>
	<li class='all'><a href='<?php echo U('/Admin/Employee/index');?>' class="current">全部<span class="count">（<?php echo ($employeeCount); ?>）</span></a></li>
</ul>
...
<table class="wp-list-table widefat fixed striped users">
	...
	<tr>
        ...
        <th scope='col' class='manage-column column-uname'><span class="manage-column column-telnum">登录名</span></th>
        <th scope='col' class='manage-column column-kind'>姓名</th>
        <th scope="col" class="manage-column column-cdate sortable desc">所属分组</th>
        <th scope='col' class='manage-column column-baobeiren'>状态</th>
        </thead>

	<tbody id="the-list" data-wp-lists='list:user'>
    <?php if(is_array($elist)): $i = 0; $__LIST__ = $elist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    <td class="ctext-left"><?php echo ($vo["eid"]); ?></td>
    <td class="ctext-left"><strong><a href="<?php echo U('Employee/editemployee');?>?id=<?php echo ($vo["eid"]); ?>"><?php echo ($vo["user_login"]); ?></a></strong><br /><div class="row-actions"><span class='edit'><a href="<?php echo U('Employee/editemployee');?>?id=<?php echo ($vo["eid"]); ?>">编辑</a> | </span><span class='delete'><a class='submitdelete' href='<?php echo U('Employee/delemployee');?>?id=<?php echo ($vo["eid"]); ?>'>删除</a></span></div></td>
    <td class="ctext-left"><?php echo ($vo["user_name"]); ?></td>
    <td class="ctext-left">
    <?php if(is_array($glist)): $i = 0; $__LIST__ = $glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gvo): $mod = ($i % 2 );++$i; if(($gvo["gid"]) == $vo["group_id"]): echo ($gvo["title"]); endif; endforeach; endif; else: echo "" ;endif; ?>
    </td>
    <td class="ctext-left"><?php echo ($vo["status"]); ?></td>
