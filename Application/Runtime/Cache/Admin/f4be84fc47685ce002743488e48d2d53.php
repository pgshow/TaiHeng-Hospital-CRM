...
<div class="wrap">
<h2>
专家	<a href="<?php echo U('Doctor/adddoctor');?>" class="add-new-h2">添加专家</a>
</h2>

<ul class='subsubsub'>
	<li class='all'><a href='<?php echo U('/Admin/Doctor/index');?>' class="current">全部<span class="count">（<?php echo ($doctorCount); ?>）</span></a></li>
</ul>
...
<table class="wp-list-table widefat fixed striped users">
	...
	<tr>
        ...
        <th scope='col' class='manage-column column-uname'><span class="manage-column column-telnum">专家</span></th>
        </thead>

	<tbody id="the-list" data-wp-lists='list:user'>
    <?php if(is_array($dlist)): $i = 0; $__LIST__ = $dlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    <td class="ctext-left"><?php echo ($vo["did"]); ?></td>
    <td class="ctext-left"><strong><?php echo ($vo["doctor_name"]); ?></strong><br /><div class="row-actions"><span class='delete'><a class='submitdelete' href='<?php echo U('Doctor/deldoctor');?>?id=<?php echo ($vo["did"]); ?>'>删除</a></span></div></td>
